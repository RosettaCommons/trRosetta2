...
def install_dependencies(prefix):
    ...
    for p in [
        PackageInfo('weights',             'https://files.ipd.uw.edu/pub/trRosetta2/weights.tar.bz2', None, None),
        PackageInfo('uniclust30',          'http://wwwuser.gwdg.de/~compbiol/uniclust/2020_06/UniRef30_2020_06_hhsuite.tar.gz', 'UniRef30_2020_06', None),
        PackageInfo('structure-templates', 'https://files.ipd.uw.edu/pub/trRosetta2/pdb100_2020Mar11.tar.gz', None, None),

        PackageInfo('lddt',     f'https://openstructure.org/static/lddt-{_platform_}.zip', 'ldd', True),
        PackageInfo('cs-blast', f'http://wwwuser.gwdg.de/~compbiol/data/csblast/releases/csblast-2.2.3_{_platform_arch_}.tar.gz', 'cs-blast', True),

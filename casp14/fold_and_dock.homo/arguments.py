...
def get_args(params):
    ...
    parser.add_argument("SYMM", type=str, help="input symmdef file")
    ...
    parser.add_argument('-pd', type=float, dest='pcut', default=params['PCUT'], help='min probability of distance restraints (0.05, 0.15, 0.25, 0.35, or 0.45)')
